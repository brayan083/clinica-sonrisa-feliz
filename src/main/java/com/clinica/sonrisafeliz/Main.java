...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        // ── 3. Crear odontólogos ───────────────────────────────
        // El ID se genera automáticamente en el constructor.
        Odontologo drLopez    = new Odontologo("Diego",   "López",   "MAT-001");
        Odontologo draSanchez = new Odontologo("Valeria", "Sánchez", "MAT-002");

        // ── 4. Crear turnos ────────────────────────────────────
        // El ID se genera automáticamente en el constructor.
        // El estado inicial siempre es PENDIENTE.
        Turno turno1 = new Turno(ana, drLopez,
                LocalDate.of(2026, 4, 15), LocalTime.of(9, 0));

        Turno turno2 = new Turno(carlos, draSanchez,
                LocalDate.of(2026, 4, 15), LocalTime.of(10, 30));

        Turno turno3 = new Turno(lucia, drLopez,
                LocalDate.of(2026, 4, 16), LocalTime.of(14, 0));

        Turno turnoPasado = new Turno(ana, draSanchez,
                LocalDate.of(2026, 3, 1), LocalTime.of(11, 0));

        // Ajustamos los estados que difieren del PENDIENTE inicial.
        turno2.setEstado(EstadoTurno.CONFIRMADO);
        turnoPasado.setEstado(EstadoTurno.COMPLETADO);

        // ── 5. Imprimir pacientes ──────────────────────────────
        ...
        // ── 8. Verificar métodos de negocio ───────────────────
        ...
        // ── 9. Verificar equals/hashCode por DNI ──────────────
        ...
        System.out.println("\n=======================================================");
        System.out.println("  Entrega 1 completada sin errores ✓                  ");
        System.out.println("=======================================================");
    }
